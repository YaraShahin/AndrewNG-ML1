...
#axis=0 means to find the max-min per column (feature)
print("peak to peak original", np.ptp(X_train, axis=0))
print("peak to peak normalized", np.ptp(X_norm, axis=0))
...
print("For features of:",X_norm[0:1,], "The prediction is:", y_pred_sgd[0],". The actual target is", y_train[0])